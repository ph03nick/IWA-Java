pipeline {
    ...
    environment {
        ...
        APP_VERSION_SSC = "4.0"
        urlGit = 'https://github.com/adliaulia/IWA-Java.git'
    ...
    stages {
        ...
        stage('Fortify Trigger Scan SAST') {
            ...
            steps {
                ...
                Start-Sleep -s 30
                # ==================================== Cek Scan Selesai ================================
                # Add Condition Trigger Only
                if ($triggerOnly -eq "no") {
                	# Cek Status scan SAST
                    ...
                    # Get Saverity Hasil Scan SAST
                    Write-Host "--- Get Saverity Hasil Scan SAST ---"
                    $critical = 9999
                    $high = 9999
        ...
        stage('Fortify Trigger Scan DAST') {
            ...
            steps {
                ...
                if ($triggerOnly -eq "no") {
                	...
                	# Get Saverity Hasil Scan DAST
                	Write-Host "--- Get Saverity Hasil Scan DAST ---"
                	$critical = 9999
					$high = 9999
